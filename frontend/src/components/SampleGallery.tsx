...
export const SAMPLES: SampleItem[] = [
  {
    id: "melanoma",
    path: "/samples/melanoma.jpg",
    label: "Melanoma",
    sublabel: "Malignant Biopsy",
    chip: "MEL",
    chipColor: "bg-rose-600/90",
  },
  {
    id: "nevi",
    path: "/samples/nevus.jpg",
    label: "Melanocytic Nevi",
    sublabel: "Benign Mole",
    chip: "NV",
    chipColor: "bg-emerald-600/90",
  },
  {
    id: "keratosis",
    path: "/samples/keratosis.jpg",
    label: "Benign Keratosis",
    sublabel: "Seborrheic K.",
    chip: "BKL",
    chipColor: "bg-sky-600/90",
  },
  {
    id: "bcc",
    path: "/samples/bcc.jpg",
    label: "Basal Cell Ca.",
    sublabel: "Basal Cell Carcinoma",
    chip: "BCC",
    chipColor: "bg-rose-600/90",
  },
];
